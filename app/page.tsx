    ...
    <>
      <main>
        ...
        <Container className="py-12 overflow-hidden">
          <Heading as="h2" variant="gradient" size="h1" color="dark" className="text-center mb-6 md:mb-12">Projects I’m Proud Of</Heading>
          ...
          <div className="flex justify-center">
            <Button variant="gradient" color="light" size="md" href="/portfolio">All projects</Button>
          </div>
        </Container>

        <div className="bg-gray-50 py-12">
          <Container>
            <Heading as="h2" variant="gradient" size="h1" color="primary" className="text-center mb-4">Services</Heading>
        ...
        <Container className="py-12">
          <Heading as="h2" variant="gradient" size="h1" color="primary" className="text-center mb-6 md:mb-12">Who I Am</Heading>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-brand-primary-500 to-purple-600 rounded-2xl p-8 text-white shadow-xl">
                ...
                <h3 className="text-xl font-semibold mb-4">Based in Copenhagen</h3>
                <p className="text-blue-100 leading-relaxed">
                  Originally from Ukraine, now based in Copenhagen, I work with clients worldwide.
                </p>
              </div>
        ...
        <div className="bg-brand-primary-500">
          <Container className="py-12">
            <Heading as="h2" variant="gradient" size="h1" color="light" className="text-center mb-6 md:mb-12">What Clients Say</Heading>
            <Testimonials/>
          </Container>
        </div>
